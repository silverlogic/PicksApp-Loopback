    ...
    if (year < 2018 && week < 18) {
      ...
      schedules.forEach(function(schedule) {
        ...
        request.get('http://api.openweathermap.org/data/2.5/weather')
          .query({
            lat: teamLocation.location.lat,
            lon: teamLocation.location.lon, appid: apiKey,
          }) // query string
          .end(function(err, res) {
            ...
            Weather.upsertWithWhere(
              ...
              {
                team: teamLocation.name,
                location: teamLocation.location, dome: teamLocation.dome,
